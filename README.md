# Health Claim Checker (Minimal Reset)

This is a rebuilt minimal project with:
- a trained text model backend (`TF-IDF + LogisticRegression`)
- a simple frontend that calls the API

## Setup

```bash
cd health_misinformation
python3 -m venv .venv
...
Run a static frontend for quick local testing:
